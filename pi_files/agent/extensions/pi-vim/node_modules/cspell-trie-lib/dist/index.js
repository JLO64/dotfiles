...
var CharIndex = class CharIndex {
	...
	static fromJSON(json) {
		const charIndex = new Set(json.charIndex);
...
const setOfSeparators = /* @__PURE__ */ new Set(["+", " "]);
		...
		if (idxDirective >= 0) {
			...
			for (const flag of flags) switch (flag) {
				...
				case "no-generate-alternatives":
					...
					break;
				case "generate-alternatives": stripCaseAndAccents = true;
			}
		}
...
const specialCharacterMap = /* @__PURE__ */ new Map([
	["\n", "\\n"],
	["\r", "\\r"],
	["\\", "\\\\"]
]);
